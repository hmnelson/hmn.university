...
from hmn.university.browser.widgets.price_radio_widget import IPriceRadioWidget

@implementer(IDataConverter)
class PriceConverter(FloatDataConverter):

    adapts(zope.schema.interfaces.IFloat, IPriceRadioWidget)
