...
#
#  $ bin/test -s hmn.university -t test_teacher.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/hmn/university/tests/robot/test_teacher.robot
#
...
a Teacher 'My Teacher'
  Create content  type=Department  id=my-teacher  title=My Teacher
