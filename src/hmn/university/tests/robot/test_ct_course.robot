...
#
#  $ bin/test -s hmn.university -t test_course.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/hmn/university/tests/robot/test_course.robot
#
...
a Course 'My Course'
  Create content  type=Department  id=my-course  title=My Course
